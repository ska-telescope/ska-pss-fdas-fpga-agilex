...
#     PCIE_HIP_FDAS_mm_wr_transparent_2
# 
...
# ----------------------------------------
# If PCIE_HIP_FDAS_mm_wr_transparent_2 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.4 94 win32 2023.03.01.08:55:32
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PCIE_HIP_FDAS_mm_wr_transparent_2.PCIE_HIP_FDAS_mm_wr_transparent_2"
}
...
append ELAB_OPTIONS [subst [PCIE_HIP_FDAS_mm_wr_transparent_2::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [PCIE_HIP_FDAS_mm_wr_transparent_2::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [PCIE_HIP_FDAS_mm_wr_transparent_2::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [PCIE_HIP_FDAS_mm_wr_transparent_2::normalize_path "$file"]
  set normalized_dest [PCIE_HIP_FDAS_mm_wr_transparent_2::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [PCIE_HIP_FDAS_mm_wr_transparent_2::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [PCIE_HIP_FDAS_mm_wr_transparent_2::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [PCIE_HIP_FDAS_mm_wr_transparent_2::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
