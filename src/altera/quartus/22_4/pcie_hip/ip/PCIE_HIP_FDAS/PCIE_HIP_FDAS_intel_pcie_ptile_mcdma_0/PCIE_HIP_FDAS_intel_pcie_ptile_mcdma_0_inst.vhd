	...
	u0 : component PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0
		port map (
			...
			rx_pio_waitrequest_i        => CONNECTED_TO_rx_pio_waitrequest_i,        --  p0_rx_pio_master.waitrequest
			...
			d2hdm_waitrequest_i         => CONNECTED_TO_d2hdm_waitrequest_i,         --   p0_d2hdm_master.waitrequest
			...
			h2ddm_waitrequest_i         => CONNECTED_TO_h2ddm_waitrequest_i,         --   p0_h2ddm_master.waitrequest
			...
			usr_event_msix_valid_i      => CONNECTED_TO_usr_event_msix_valid_i,      --       p0_usr_msix.valid
			...
			usr_hip_tl_cfg_func_o       => CONNECTED_TO_usr_hip_tl_cfg_func_o,       --  p0_usr_config_tl.tl_cfg_func
