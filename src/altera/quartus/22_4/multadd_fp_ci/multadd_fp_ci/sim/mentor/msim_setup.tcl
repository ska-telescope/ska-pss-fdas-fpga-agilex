...
# ----------------------------------------
# If multadd_fp_ci is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.2 94 win32 2022.07.19.13:00:29
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [multadd_fp_ci::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [multadd_fp_ci::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [multadd_fp_ci::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [multadd_fp_ci::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [multadd_fp_ci::normalize_path "$file"]
  set normalized_dest [multadd_fp_ci::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [multadd_fp_ci::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [multadd_fp_ci::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [multadd_fp_ci::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
