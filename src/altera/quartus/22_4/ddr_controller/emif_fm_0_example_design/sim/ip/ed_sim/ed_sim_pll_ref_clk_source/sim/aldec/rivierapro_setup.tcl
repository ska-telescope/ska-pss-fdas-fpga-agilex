...
# ACDS 22.2 94 win32 2022.08.01.12:08:50
# ----------------------------------------
...
# ----------------------------------------
# If ed_sim_pll_ref_clk_source is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ed_sim_pll_ref_clk_source.ed_sim_pll_ref_clk_source"
}
...
append ELAB_OPTIONS [subst [ed_sim_pll_ref_clk_source::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [ed_sim_pll_ref_clk_source::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [ed_sim_pll_ref_clk_source::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [ed_sim_pll_ref_clk_source::normalize_path "$file"]
  set normalized_dest [ed_sim_pll_ref_clk_source::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [ed_sim_pll_ref_clk_source::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [ed_sim_pll_ref_clk_source::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [ed_sim_pll_ref_clk_source::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
