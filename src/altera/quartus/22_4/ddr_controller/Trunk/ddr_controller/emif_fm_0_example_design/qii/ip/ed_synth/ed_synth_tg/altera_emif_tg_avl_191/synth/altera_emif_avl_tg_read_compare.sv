...
module altera_emif_avl_tg_read_compare # (
   ...
   logic [WORD_ADDR_WIDTH-1:0]   read_exact_word_addr;
   ...
   begin
      ...
      read_exact_word_addr_r <= read_exact_word_addr;
   ...
   assign read_exact_word_addr = read_addr[ADDR_WIDTH-1:(ADDR_WIDTH - WORD_ADDR_WIDTH)] + read_burstcount - read_burstleft - 1'b1;
...
`endif
   ...
   logic [1:0]              addr_fifo_write_req_r;
   ...
   altera_emif_avl_tg_scfifo_wrapper # (
      ...
      .read_req        (nxt_addr_fifo_read_req),
   ...
   // for the nxt_addr_fifo_read_req signal.
   ...
   begin
      ...
      else if(nxt_addr_fifo_read_req & !addr_fifo_write_req_r[1])begin
          if(addr_fifo_cnt == 1)
            addr_fifo_empty   <= 1'b1;
   ...
   begin
      if (!reset_n) begin
         ...
         addr_fifo_write_req_r <= {addr_fifo_write_req_r[0],addr_fifo_write_req};
      end
   end
