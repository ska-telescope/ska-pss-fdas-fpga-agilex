...
namespace eval FDAS_DDR_CONTROLLER_HPS {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_uwtpndq_top.sv"]\"  -work altera_emif_arch_fm_191"
