...
namespace eval FDAS_EMIF_CALIBRATION {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_cal_iossm_262/sim/FDAS_EMIF_CALIBRATION_altera_emif_cal_iossm_262_7er3wya_arch.sv"]\"  -work altera_emif_cal_iossm_262"
