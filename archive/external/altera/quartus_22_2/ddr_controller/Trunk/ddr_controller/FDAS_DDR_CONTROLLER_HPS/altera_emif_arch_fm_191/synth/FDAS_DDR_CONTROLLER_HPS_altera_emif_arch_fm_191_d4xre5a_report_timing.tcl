...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_corename}"
   } else {
      set fbasename "${::GLOBAL_FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_corename}_${inst_id}"
   }
   ...
   FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_perform_core_analysis $opcname $inst pins var summary


   set summary [lsort -command FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ FDAS_DDR_CONTROLLER_HPS_altera_emif_arch_fm_191_d4xre5a_round_3dp $hold]
      }
