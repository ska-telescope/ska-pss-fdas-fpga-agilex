...
---------------------
 ...
 12. On-Chip Termination (OCT) interface
 13. Interface between FPGA and external memory
 14. PHY calibration status interface
 15. User clock domain reset interface
 16. User clock interface
 17. Controller Avalon Streaming command interface 0
 18. Controller Avalon Streaming write data interface 0
 19. Controller Avalon Streaming read data interface 0
 20. Controller ECC interface 0
 21. EMIF calibration component interface
 22. EMIF calibration component clock input interface
 23. Instantiating IP in a simulation project
 24. Full-calibration versus skip-calibration simulation
 25. IP Settings
...
------------------------
   ...
   This is the readme file for the Intel External Memory Interface (EMIF) IP v22.2.
...
--------------------
   ...
   SYS_INFO_UNIQUE_ID                                : FDAS_DDR_CONTROLLER_HPS_emif_fm_0
   ...
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_5                   : 1333.333
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_5                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_6                   : 1333.333
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_6                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_7                   : 1333.333
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_7                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_8                   : 1333.333
   ...
   MEM_READ_LATENCY                                  : 26.0
   MEM_WRITE_LATENCY                                 : 17
   MEM_BURST_LENGTH                                  : 8
