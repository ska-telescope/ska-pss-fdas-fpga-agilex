...
set ::GLOBAL_FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_opikega_corename FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_opikega
...
set var(tQH)                                                     0.43
set var(tDS)                                                     0.03750000937500234
set var(tDH)                                                     0.03750000937500234
set var(tIS)                                                     0.055
set var(tIH)                                                     0.08
set var(tDQSCK)                                                  0.17
set var(tDQSS)                                                   0.27
...
set var(PHY_MEM_CLK_FREQ_MHZ)                                    1333.333
set var(PHY_REF_CLK_FREQ_MHZ)                                    166.667
set var(PHY_REF_CLK_JITTER_PS)                                   10.0
set var(PLL_REF_CLK_FREQ_PS_STR)                                 "6000 ps"
