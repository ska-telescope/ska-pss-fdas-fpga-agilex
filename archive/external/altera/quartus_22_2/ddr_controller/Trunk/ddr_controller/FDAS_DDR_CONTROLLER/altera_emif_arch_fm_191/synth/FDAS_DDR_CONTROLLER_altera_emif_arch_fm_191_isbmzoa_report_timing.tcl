...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_corename}"
   } else {
      set fbasename "${::GLOBAL_FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_corename}_${inst_id}"
   }
   ...
   FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_perform_core_analysis $opcname $inst pins var summary


   set summary [lsort -command FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_isbmzoa_round_3dp $hold]
      }
