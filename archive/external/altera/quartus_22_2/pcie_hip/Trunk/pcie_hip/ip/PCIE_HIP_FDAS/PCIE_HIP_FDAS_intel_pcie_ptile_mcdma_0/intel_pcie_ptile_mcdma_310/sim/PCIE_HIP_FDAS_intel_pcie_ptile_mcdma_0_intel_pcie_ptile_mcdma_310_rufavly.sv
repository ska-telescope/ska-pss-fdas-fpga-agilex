...
module PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_mcdma_310_rufavly #(
          ...
          parameter core8_refclk_init_active_hwtcl                              = 1,
         ...
         //p1 rx_st ports
         output  [core8_payload_width_integer_hwtcl-1:0]                               p1_rx_st_data_o,                      
         output  [core8_hdr_width_integer_hwtcl-1:0]                                   p1_rx_st_hdr_o,      
         output  [core8_pfx_width_integer_hwtcl-1:0]                                   p1_rx_st_tlp_prfx_o,
         output  [core8_double_width_integer_hwtcl-1:0]                                p1_rx_st_eop_o,      
         output  [core8_double_width_integer_hwtcl-1:0]                                p1_rx_st_sop_o,                 
         input                                                                         p1_rx_st_ready_i,
         output  [core8_double_width_integer_hwtcl*3-1:0]                              p1_rx_st_func_num_o,
         output  [core8_double_width_integer_hwtcl*4-1:0]                              p1_rx_st_tlp_prfx_par_o,
         output  [core8_double_width_integer_hwtcl*16-1:0]                             p1_rx_st_hdr_par_o,              
         output  [core8_double_width_integer_hwtcl*11-1:0]                             p1_rx_st_vf_num_o,                       
         output  [core8_double_width_integer_hwtcl*3-1:0]                              p1_rx_st_bar_range_o,  
         output  [core8_double_width_integer_hwtcl-1:0]                                p1_rx_st_tlp_abort_o,
         output  [core8_empty_width_integer_hwtcl-1:0]                                 p1_rx_st_empty_o,                
         output  [core8_double_width_integer_hwtcl-1:0]                                p1_rx_st_vf_active_o,              
         output  [core8_double_width_integer_hwtcl*32-1:0]                             p1_rx_st_data_par_o,              
         output  [core8_double_width_integer_hwtcl-1:0]                                p1_rx_st_valid_o,                     
         output                                                                        p1_rx_par_err_o,   
         //p1 tx_st ports
         input   [core8_payload_width_integer_hwtcl-1:0]                               p1_tx_st_data_i,
         input   [core8_hdr_width_integer_hwtcl-1:0]                                   p1_tx_st_hdr_i,
         input   [core8_pfx_width_integer_hwtcl-1:0]                                   p1_tx_st_tlp_prfx_i,        
         input   [core8_payload_width_integer_hwtcl/8-1:0]                             p1_tx_st_data_par_i,        
         input   [core8_double_width_integer_hwtcl-1:0]                                p1_tx_st_valid_i,
         input   [core8_double_width_integer_hwtcl-1:0]                                p1_tx_st_sop_i,
         input   [core8_double_width_integer_hwtcl-1:0]                                p1_tx_st_err_i,
         input   [core8_double_width_integer_hwtcl*16-1:0]                             p1_tx_st_hdr_par_i,
         input   [core8_double_width_integer_hwtcl-1:0]                                p1_tx_st_eop_i,
         output  reg                                                                   p1_tx_st_ready_o,
         input   [core8_double_width_integer_hwtcl*4-1:0]                              p1_tx_st_tlp_prfx_par_i,
         output                                                                        p1_tx_par_err_o,
              
         input  [11:0]                                                                 p1_rx_buffer_limit_i,
         input  [1:0]                                                                  p1_rx_buffer_limit_tdm_idx_i,            
         //p1 tx_cdts ports                                                            
         output  [15:0]                                                                p1_tx_cdts_limit_o,
         output  [2:0]                                                                 p1_tx_cdts_limit_tdm_idx_o,
                                                                                       
         //p1 flr_ ports                                                                 
         output  [10:0]                                                                p1_flr_rcvd_vf_num_o,
         output                                                                        p1_flr_rcvd_vf_o,
         output  [2:0]                                                                 p1_flr_rcvd_pf_num_o,
         output  [7:0]                                                                 p1_flr_rcvd_pf_o,
         input  [2:0]                                                                  p1_flr_completed_pf_num_i,
         input  [10:0]                                                                 p1_flr_completed_vf_num_i,
         input                                                                         p1_flr_completed_vf_i,
         input  [7:0]                                                                  p1_flr_completed_pf_i,
         //p1 virtio ports                                                               
         ...
         //p1 user_avmm ports
         output                                                                        p1_hip_reconfig_waitrequest,
         input                                                                         p1_hip_reconfig_read,
         input    [20:0]                                                               p1_hip_reconfig_address,
         input                                                                         p1_hip_reconfig_write,
         input    [7:0]                                                                p1_hip_reconfig_writedata,
         input                                                                         p1_hip_reconfig_clk,
         output                                                                        p1_hip_reconfig_readdatavalid,
         output    [7:0]                                                               p1_hip_reconfig_readdata,
         //p1 _int_ ports
         input  [7:0]                                                                  p1_app_int_i,
         output                                                                        p1_int_status_o,
         //p1 msi ports                                                              
         input  [7:0]                                                                  p1_msi_pnd_byte_i,
         input  [2:0]                                                                  p1_msi_pnd_func_i,
         input   [1:0]                                                                 p1_msi_pnd_addr_i,
         //p1 test_ ports                                                            
         input                                                                         p1_test_in_i,
         output  [69:0]                                                                p1_test_out_o,
         //p1                                                                        
         output                                                                        p1_cpl_timeout_o,
         output                                                                        p1_cpl_timeout_waitrequest_o,
         input                                                                         p1_cpl_timeout_avmm_read_i,
         input   [2:0]                                                                 p1_cpl_timeout_avmm_address_i,
         input                                                                         p1_cpl_timeout_avmm_write_i,
         input   [7:0]                                                                 p1_cpl_timeout_avmm_writedata_i,
         input                                                                         p1_cpl_timeout_avmm_clk_i,
         output                                                                        p1_cpl_timeout_avmm_readdatavalid_o,
         output  [7:0]                                                                 p1_cpl_timeout_avmm_readdata_o,
                                                                                     
         //p1 tl_cfg ports                                                           
         output  [2:0]                                                                 p1_tl_cfg_func_o,  //terminated in RP mode
         output  [15:0]                                                                p1_tl_cfg_ctl_o,
         output  [4:0]                                                                 p1_tl_cfg_add_o,
         ...
         //p1 err_ ports                                                               
         input                                                                         p1_app_err_valid_i,
         input  [12:0]                                                                 p1_app_err_info_i,
         input  [31:0]                                                                 p1_app_err_hdr_i,        //add soft logic to convert hdr+prfx to 5 cycles of 32bit
         output                                                                        p1_serr_out_o,
         input  [2:0]                                                                  p1_app_err_func_num_i,
         output                                                                        p1_hip_enter_err_mode_o,
         //p1 sys_ ports                                                             
         input                                                                         p1_sys_mrl_sensor_state_i,
         input                                                                         p1_sys_mrl_sensor_chged_i,
         input                                                                         p1_sys_pre_det_state_i,
         input                                                                         p1_sys_atten_button_pressed_i,
         input                                                                         p1_sys_pwr_fault_det_i,
         input                                                                         p1_sys_aux_pwr_det_i,
         input                                                                         p1_sys_eml_interlock_engaged_i,
         input                                                                         p1_sys_pre_det_chged_i,
         input                                                                         p1_sys_cmd_cpled_int_i,
      ...
      logic                                       p0_dtk_hip_reconfig_clk;
      logic                                       p1_dtk_hip_reconfig_clk;                
      ...
      intel_pcie_mcdma_ptile_wrapper #(
        ...
        .dl_timer_update_o                    ( p0_dl_timer_update_o              ),
        ...
        .hip_reconfig_clk_o                   ( p0_hip_reconfig_clk               ),
        ...
        .cpl_timeout_avmm_clk_o               ( p0_cpl_timeout_avmm_clk_i          ),
        ...
        .usr_hip_reconfig_rst_n_i         (    usr_hip_reconfig_rst_n_i      ), 
