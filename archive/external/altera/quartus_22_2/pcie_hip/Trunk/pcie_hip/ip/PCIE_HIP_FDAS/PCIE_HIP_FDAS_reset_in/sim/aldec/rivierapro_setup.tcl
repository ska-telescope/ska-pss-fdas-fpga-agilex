...
# ACDS 22.2 94 win32 2022.06.24.09:33:40
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     PCIE_HIP_FDAS_reset_in
# 
...
# ----------------------------------------
# If PCIE_HIP_FDAS_reset_in is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PCIE_HIP_FDAS_reset_in.PCIE_HIP_FDAS_reset_in"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [PCIE_HIP_FDAS_reset_in::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [PCIE_HIP_FDAS_reset_in::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [PCIE_HIP_FDAS_reset_in::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [PCIE_HIP_FDAS_reset_in::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [PCIE_HIP_FDAS_reset_in::normalize_path "$file"]
  set normalized_dest [PCIE_HIP_FDAS_reset_in::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [PCIE_HIP_FDAS_reset_in::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [PCIE_HIP_FDAS_reset_in::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [PCIE_HIP_FDAS_reset_in::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
