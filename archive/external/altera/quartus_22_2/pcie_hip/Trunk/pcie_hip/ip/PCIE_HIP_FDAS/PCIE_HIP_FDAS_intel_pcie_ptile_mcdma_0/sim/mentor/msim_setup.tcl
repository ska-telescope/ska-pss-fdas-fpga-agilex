...
#     PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0
# 
...
# ----------------------------------------
# If PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.2 94 win32 2023.01.24.09:27:16
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0.PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0"
}
...
append ELAB_OPTIONS [subst [PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0::normalize_path "$file"]
  set normalized_dest [PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0::normalize_path "$dest_file"]
...
set logical_libraries [list "work" "work_lib" "altera_ver" "lpm_ver" "sgate_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hssi_ver" "tennm_hssi_e0_ver" "tennm_hssi_p0_ver" "altera" "lpm" "sgate" "altera_mf" "altera_lnsim" "tennm" "tennm_hssi" "tennm_hssi_e0" "tennm_hssi_p0"]
...
set design_libraries [dict merge $design_libraries [PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0::get_design_libraries]]
...
alias dev_com {
  ...
  if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
    ...
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/fp4_maibo_atoms_ncrypt.sv"            -work tennm_ver        
    ...
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms_ncrypt.sv"             -work tennm_hssi_p0_ver
...
alias com {
  ...
  set design_files [dict merge [PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
