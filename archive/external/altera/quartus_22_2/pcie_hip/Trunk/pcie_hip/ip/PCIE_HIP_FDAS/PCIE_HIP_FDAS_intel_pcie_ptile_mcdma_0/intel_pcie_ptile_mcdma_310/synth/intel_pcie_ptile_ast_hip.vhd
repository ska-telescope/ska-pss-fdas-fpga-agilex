...
library IEEE;
library intel_pcie_ptile_ast_810;
...
entity intel_pcie_ptile_ast_hip is
	generic (
		...
		core16_enable_pld_warm_rst_rdy_hwtcl                        : integer := 1;
		...
		core16_hip_reconfig_hwtcl                                   : integer := 1;
	...
	port (
		...
		p0_pld_warm_rst_rdy_i               : in  std_logic                                                          := '0';             --              p0_pld.pld_warm_rst_rdy,      Handshake signal to pld_link_req_rst_o. User asserts pld_warm_rst_rdy_i when application layer is ready for reset. This signal should remain asserted until pld_link_req_rst_o  deasserted or reset_status_n_o asserted.
		p0_pld_link_req_rst_o               : out std_logic;                                                                             --                    .link_req_rst_n,        Asserts when there is a pending hot reset or warm reset request from PCIe Controller. User is expected to perform necessary action in preparation for the reset. User asserts pld_warm_rst_rdy_i in response to pld_link_req_rst_o to allow PCIe Controller to be reset.
		...
		p0_hip_reconfig_clk                 : in  std_logic                                                          := '0';             -- p0_hip_reconfig_clk.clk,                   Check User Guide for details
		p0_hip_reconfig_address             : in  std_logic_vector(20 downto 0)                                      := (others => '0'); --     p0_hip_reconfig.address,               Check User Guide for details
		p0_hip_reconfig_read                : in  std_logic                                                          := '0';             --                    .read,                  Check User Guide for details
		p0_hip_reconfig_readdata            : out std_logic_vector(7 downto 0);                                                          --                    .readdata,              Check User Guide for details
		p0_hip_reconfig_readdatavalid       : out std_logic;                                                                             --                    .readdatavalid,         Check User Guide for details
		p0_hip_reconfig_write               : in  std_logic                                                          := '0';             --                    .write,                 Check User Guide for details
		p0_hip_reconfig_writedata           : in  std_logic_vector(7 downto 0)                                       := (others => '0'); --                    .writedata,             Check User Guide for details
		p0_hip_reconfig_waitrequest         : out std_logic;                                                                             --                    .waitrequest,           Check User Guide for details
...
architecture rtl of intel_pcie_ptile_ast_hip is
	component PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_ast_810_rqhox5y_cmp is
		generic (
	...
	end component PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_ast_810_rqhox5y_cmp;

	for intel_pcie_ptile_ast_hip : PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_ast_810_rqhox5y_cmp
		use entity intel_pcie_ptile_ast_810.PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_ast_810_rqhox5y;
begin
	...
	core16_enable_pld_warm_rst_rdy_hwtcl_check : if core16_enable_pld_warm_rst_rdy_hwtcl /= 1 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	core16_hip_reconfig_hwtcl_check : if core16_hip_reconfig_hwtcl /= 1 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	core8_refclk_init_active_hwtcl_check : if core8_refclk_init_active_hwtcl /= 1 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	intel_pcie_ptile_ast_hip : component PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_ast_810_rqhox5y_cmp
		generic map (
		...
		port map (
			...
			p0_hip_reconfig_clk                 => p0_hip_reconfig_clk,                                                                                                                                                                                                                                                -- p0_hip_reconfig_clk.clk
			p0_hip_reconfig_address             => p0_hip_reconfig_address,                                                                                                                                                                                                                                            --     p0_hip_reconfig.address
			p0_hip_reconfig_read                => p0_hip_reconfig_read,                                                                                                                                                                                                                                               --                    .read
			p0_hip_reconfig_readdata            => p0_hip_reconfig_readdata,                                                                                                                                                                                                                                           --                    .readdata
			p0_hip_reconfig_readdatavalid       => p0_hip_reconfig_readdatavalid,                                                                                                                                                                                                                                      --                    .readdatavalid
			p0_hip_reconfig_write               => p0_hip_reconfig_write,                                                                                                                                                                                                                                              --                    .write
			p0_hip_reconfig_writedata           => p0_hip_reconfig_writedata,                                                                                                                                                                                                                                          --                    .writedata
			p0_hip_reconfig_waitrequest         => p0_hip_reconfig_waitrequest,                                                                                                                                                                                                                                        --                    .waitrequest
