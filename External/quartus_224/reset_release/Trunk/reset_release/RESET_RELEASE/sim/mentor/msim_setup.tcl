...
# ----------------------------------------
# If RESET_RELEASE is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.2 94 win32 2022.07.19.13:22:23
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "RESET_RELEASE.RESET_RELEASE"
}
...
append ELAB_OPTIONS [subst [RESET_RELEASE::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [RESET_RELEASE::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [RESET_RELEASE::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [RESET_RELEASE::normalize_path "$file"]
  set normalized_dest [RESET_RELEASE::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [RESET_RELEASE::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [RESET_RELEASE::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [RESET_RELEASE::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
