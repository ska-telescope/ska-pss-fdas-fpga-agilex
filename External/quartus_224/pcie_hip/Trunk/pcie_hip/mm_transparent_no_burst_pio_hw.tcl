...
# Fri Jan 06 10:11:09 GMT 2023
# DO NOT MODIFY


# 
# mm_transparent_no_burst_pio "mm_transparent_no_burst_pio" v1.0
#  2023.01.06.10:11:09
# 
# 
...
# 
# module mm_transparent_no_burst_pio
# 
set_module_property DESCRIPTION ""
set_module_property NAME mm_transparent_no_burst_pio
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME mm_transparent_no_burst_pio
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL mm_transparent_no_burst_pio
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file mm_transparent_no_burst_pio.vhd VHDL PATH ../../../../PCIE_HIP/hdl/mm_transparent_no_burst_pio.vhd TOP_LEVEL_FILE
add_fileset_file mm_transparent_no_burst_pio_synth.vhd VHDL PATH ../../../../PCIE_HIP/hdl/mm_transparent_no_burst_pio_synth.vhd

add_fileset SIM_VHDL SIM_VHDL "" ""
set_fileset_property SIM_VHDL TOP_LEVEL mm_transparent_no_burst_pio
set_fileset_property SIM_VHDL ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VHDL ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file mm_transparent_no_burst_pio.vhd VHDL PATH ../../../../PCIE_HIP/hdl/mm_transparent_no_burst_pio.vhd
add_fileset_file mm_transparent_no_burst_pio_synth.vhd VHDL PATH ../../../../PCIE_HIP/hdl/mm_transparent_no_burst_pio_synth.vhd
...
add_parameter ADDRESS_WIDTH INTEGER 20
set_parameter_property ADDRESS_WIDTH DEFAULT_VALUE 20
...
add_parameter RESPONSE_WIDTH INTEGER 2
set_parameter_property RESPONSE_WIDTH DEFAULT_VALUE 2
set_parameter_property RESPONSE_WIDTH DISPLAY_NAME RESPONSE_WIDTH
set_parameter_property RESPONSE_WIDTH UNITS None
set_parameter_property RESPONSE_WIDTH AFFECTS_GENERATION false
set_parameter_property RESPONSE_WIDTH HDL_PARAMETER true
set_parameter_property RESPONSE_WIDTH EXPORT true
...
add_interface_port s0 s0_readdata readdata Output "((data_width - 1)) - (0) + 1"
...
add_interface_port s0 s0_response response Output "((response_width - 1)) - (0) + 1"
...
add_interface_port m0 m0_readdata readdata Input "((data_width - 1)) - (0) + 1"
...
add_interface_port m0 m0_response response Input "((response_width - 1)) - (0) + 1"
