module PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0 (
		...
		input  wire         rx_pio_waitrequest_i,        //  p0_rx_pio_master.waitrequest,        Check User Guide for details
		...
		input  wire         d2hdm_waitrequest_i,         //   p0_d2hdm_master.waitrequest,        Check User Guide for details
		...
		input  wire         h2ddm_waitrequest_i,         //   p0_h2ddm_master.waitrequest,        Check User Guide for details
		...
		input  wire         usr_event_msix_valid_i,      //       p0_usr_msix.valid,              Check User Guide for details
		...
		output wire [2:0]   usr_hip_tl_cfg_func_o,       //  p0_usr_config_tl.tl_cfg_func,        Check User Guide for details
