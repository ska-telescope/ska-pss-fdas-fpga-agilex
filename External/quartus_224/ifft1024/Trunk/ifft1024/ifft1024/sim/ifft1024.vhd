...
architecture rtl of ifft1024 is
	component ifft1024_intel_FPGA_unified_fft_104_caefqgq_cmp is
		port (
	...
	end component ifft1024_intel_FPGA_unified_fft_104_caefqgq_cmp;
	...
	for intel_fpga_unified_fft_0 : ifft1024_intel_FPGA_unified_fft_104_caefqgq_cmp
		use entity intel_FPGA_unified_fft_104.ifft1024_intel_FPGA_unified_fft_104_caefqgq;
begin

	intel_fpga_unified_fft_0 : component ifft1024_intel_FPGA_unified_fft_104_caefqgq_cmp
		port map (
			clk                         => clk,                                                  --    clk.clk
			rst                         => rst,                                                  --    rst.reset_n
