...
# ACDS 22.4 94 win32 2023.02.28.09:43:36
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     FDAS_DDR_CONTROLLER_HPS
# 
...
# ----------------------------------------
# If FDAS_DDR_CONTROLLER_HPS is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FDAS_DDR_CONTROLLER_HPS.FDAS_DDR_CONTROLLER_HPS"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/intelfpga_pro/22.4/quartus/"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [FDAS_DDR_CONTROLLER_HPS::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [FDAS_DDR_CONTROLLER_HPS::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [FDAS_DDR_CONTROLLER_HPS::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [FDAS_DDR_CONTROLLER_HPS::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [FDAS_DDR_CONTROLLER_HPS::normalize_path "$file"]
  set normalized_dest [FDAS_DDR_CONTROLLER_HPS::normalize_path "$dest_file"]
...
set logical_libraries [list "work" "work_lib" "altera_ver" "lpm_ver" "sgate_ver" "altera_mf_ver" "altera_lnsim_ver" "tennm_ver" "tennm_hssi_ver" "tennm_hssi_p0_ver" "altera" "lpm" "sgate" "altera_mf" "altera_lnsim" "tennm" "tennm_hssi" "tennm_hssi_p0"]
...
set design_libraries [dict merge $design_libraries [FDAS_DDR_CONTROLLER_HPS::get_design_libraries]]
...
alias dev_com {
  ...
  eval                    vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                                     "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms.sv"                -work tennm_hssi_p0_ver
  eval                    vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                                     "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms_ncrypt.sv"         -work tennm_hssi_p0_ver
  ...
  eval                    vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                                     "$QUARTUS_INSTALL_DIR/eda/sim_lib/aldec/tennm_atoms_ncrypt.sv"      -work tennm            
  ...
  eval                    vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                                                                     "$QUARTUS_INSTALL_DIR/eda/sim_lib/tennm_hssi_atoms_ncrypt.sv"       -work tennm_hssi       
...
alias com {
  ...
  set design_files [dict merge [FDAS_DDR_CONTROLLER_HPS::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [FDAS_DDR_CONTROLLER_HPS::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
