	FDAS_EMIF_CALIBRATION u0 (
		...
		.calbus_read_1          (_connected_to_calbus_read_1_),          //  output,     width = 1,   emif_calbus_1.calbus_read
		.calbus_write_1         (_connected_to_calbus_write_1_),         //  output,     width = 1,                .calbus_write
		.calbus_address_1       (_connected_to_calbus_address_1_),       //  output,    width = 20,                .calbus_address
		.calbus_wdata_1         (_connected_to_calbus_wdata_1_),         //  output,    width = 32,                .calbus_wdata
		.calbus_rdata_1         (_connected_to_calbus_rdata_1_),         //   input,    width = 32,                .calbus_rdata
		.calbus_seq_param_tbl_1 (_connected_to_calbus_seq_param_tbl_1_), //   input,  width = 4096,                .calbus_seq_param_tbl
