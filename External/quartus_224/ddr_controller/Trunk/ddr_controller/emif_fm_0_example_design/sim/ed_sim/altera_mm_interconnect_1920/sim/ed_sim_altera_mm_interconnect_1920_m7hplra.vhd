-- ed_sim_altera_mm_interconnect_1920_m7hplra.vhd
...
entity ed_sim_altera_mm_interconnect_1920_m7hplra is
	port (
		tg_ctrl_amm_0_address                                      : in  std_logic_vector(32 downto 0)  := (others => '0'); --                                        tg_ctrl_amm_0.address
		...
		emif_fm_0_ctrl_amm_0_address                               : out std_logic_vector(25 downto 0);                     --                                 emif_fm_0_ctrl_amm_0.address
...
end entity ed_sim_altera_mm_interconnect_1920_m7hplra;

architecture rtl of ed_sim_altera_mm_interconnect_1920_m7hplra is
	component ed_sim_altera_merlin_master_translator_191_g7h47bq_cmp is
		...
		port (
			...
			uav_address            : out std_logic_vector(32 downto 0);                     -- address
			...
			av_address             : in  std_logic_vector(32 downto 0)  := (others => 'X'); -- address
	...
	component ed_sim_altera_merlin_slave_translator_191_x56fcki_cmp is
		...
		port (
			clk                    : in  std_logic                      := 'X';             -- clk
			reset                  : in  std_logic                      := 'X';             -- reset
			uav_address            : in  std_logic_vector(32 downto 0)  := (others => 'X'); -- address
	...
	signal tg_ctrl_amm_0_translator_avalon_universal_master_0_address       : std_logic_vector(32 downto 0);  -- tg_ctrl_amm_0_translator:uav_address -> emif_fm_0_ctrl_amm_0_translator:uav_address
...
end architecture rtl; -- of ed_sim_altera_mm_interconnect_1920_m7hplra
