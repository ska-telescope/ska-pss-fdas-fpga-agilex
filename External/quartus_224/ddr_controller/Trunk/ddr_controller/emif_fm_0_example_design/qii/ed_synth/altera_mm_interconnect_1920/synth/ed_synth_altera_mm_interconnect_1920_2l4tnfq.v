// ed_synth_altera_mm_interconnect_1920_2l4tnfq.v
...
`timescale 1 ps / 1 ps
module ed_synth_altera_mm_interconnect_1920_2l4tnfq (
		input  wire [33:0]  tg_ctrl_amm_0_address,                                      //                                        tg_ctrl_amm_0.address
		...
		output wire [26:0]  emif_fm_0_ctrl_amm_0_address,                               //                                 emif_fm_0_ctrl_amm_0.address
	...
	wire   [33:0] tg_ctrl_amm_0_translator_avalon_universal_master_0_address;       // tg_ctrl_amm_0_translator:uav_address -> emif_fm_0_ctrl_amm_0_translator:uav_address
	...
	ed_synth_altera_merlin_master_translator_191_g7h47bq #(
		...
		.uav_address            (tg_ctrl_amm_0_translator_avalon_universal_master_0_address),       //  output,   width = 34, avalon_universal_master_0.address
		...
		.av_address             (tg_ctrl_amm_0_address),                                            //   input,   width = 34,      avalon_anti_master_0.address
	...
	ed_synth_altera_merlin_slave_translator_191_x56fcki #(
		...
		.clk                    (emif_fm_0_emif_usr_clk_clk),                                       //   input,    width = 1,                      clk.clk
		.reset                  (tg_ctrl_amm_0_translator_reset_reset_bridge_in_reset_reset),       //   input,    width = 1,                    reset.reset
		.uav_address            (tg_ctrl_amm_0_translator_avalon_universal_master_0_address),       //   input,   width = 34, avalon_universal_slave_0.address
		...
		.av_address             (emif_fm_0_ctrl_amm_0_address),                                     //  output,   width = 27,      avalon_anti_slave_0.address
