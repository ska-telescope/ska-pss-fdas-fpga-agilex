...
namespace eval FDAS_DDR_CONTROLLER {
  proc get_design_libraries {} {
    set libraries [dict create]
    dict set libraries altera_emif_arch_fm_191 1
    dict set libraries altera_emif_fm_262      1
    dict set libraries FDAS_DDR_CONTROLLER     1
    return $libraries
  }
  
  proc get_memory_files {QSYS_SIMDIR} {
    set memory_files [list]
    lappend memory_files "[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_i3zpd5a_seq_params_synth.hex"]"
    return $memory_files
  }
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_i3zpd5a_top.sv"]\"  -work altera_emif_arch_fm_191"
    ...
    lappend design_files "vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_i3zpd5a.vhd"]\"  -work altera_emif_arch_fm_191"          
    lappend design_files "vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_fm_262/sim/FDAS_DDR_CONTROLLER_altera_emif_fm_262_xcktthi.vhd"]\"  -work altera_emif_fm_262"                         
    lappend design_files "vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/FDAS_DDR_CONTROLLER.vhd"]\"  -work FDAS_DDR_CONTROLLER"                                                                             
    return $design_files
  }
