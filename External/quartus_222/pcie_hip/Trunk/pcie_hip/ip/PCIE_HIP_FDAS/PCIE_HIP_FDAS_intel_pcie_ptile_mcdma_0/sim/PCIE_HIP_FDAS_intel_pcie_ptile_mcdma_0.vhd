...
library IEEE;
library intel_pcie_ptile_mcdma_310;
...
entity PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0 is
	port (
		...
		rx_pio_waitrequest_i        : in  std_logic                      := '0';             --     rx_pio_master.waitrequest,        Check User Guide for details
		...
		d2hdm_waitrequest_i         : in  std_logic                      := '0';             --      d2hdm_master.waitrequest,        Check User Guide for details
		...
		h2ddm_waitrequest_i         : in  std_logic                      := '0';             --      h2ddm_master.waitrequest,        Check User Guide for details
		...
		usr_event_msix_valid_i      : in  std_logic                      := '0';             --          usr_msix.valid,              Check User Guide for details
		...
		usr_hip_tl_cfg_func_o       : out std_logic_vector(2 downto 0);                      --     usr_config_tl.tl_cfg_func,        Check User Guide for details
		...
		p0_pld_warm_rst_rdy_i       : in  std_logic                      := '0';             --            p0_pld.pld_warm_rst_rdy,   Check User Guide for details
		p0_pld_link_req_rst_o       : out std_logic;                                         --                  .link_req_rst_n,     Check User Guide for details
...
architecture rtl of PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0 is
	component PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_mcdma_310_rufavly_cmp is
		generic (
			...
			core8_refclk_init_active_hwtcl                              : integer := 1;
		...
		port (
			...
			usr_hip_reconfig_rst_n_i            : in  std_logic                                             := 'X';             -- reset_n
			usr_hip_reconfig_clk_i              : in  std_logic                                             := 'X';             -- clk
			...
			p0_pld_clrpcs_n_i                   : in  std_logic                                             := 'X';             -- reset
			p1_pld_clrpcs_n_i                   : in  std_logic                                             := 'X';             -- reset
			dummy_user_avmm_rst                 : in  std_logic                                             := 'X'              -- reset
		);
	end component PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_mcdma_310_rufavly_cmp;

	for intel_pcie_ptile_mcdma_0 : PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_mcdma_310_rufavly_cmp
		use entity intel_pcie_ptile_mcdma_310.PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_mcdma_310_rufavly;
begin

	intel_pcie_ptile_mcdma_0 : component PCIE_HIP_FDAS_intel_pcie_ptile_mcdma_0_intel_pcie_ptile_mcdma_310_rufavly_cmp
		generic map (
			...
			core16_enable_pld_warm_rst_rdy_hwtcl                        => 1,
			...
			core8_refclk_init_active_hwtcl                              => 1,
		...
		port map (
			...
			rx_pio_waitrequest_i                => rx_pio_waitrequest_i,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               --     rx_pio_master.waitrequest
			...
			d2hdm_waitrequest_i                 => d2hdm_waitrequest_i,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                --      d2hdm_master.waitrequest
			...
			h2ddm_waitrequest_i                 => h2ddm_waitrequest_i,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                --      h2ddm_master.waitrequest
			...
			usr_event_msix_valid_i              => usr_event_msix_valid_i,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             --          usr_msix.valid
			usr_event_msix_ready_o              => usr_event_msix_ready_o,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             --                  .ready
			usr_event_msix_data_i               => usr_event_msix_data_i,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              --                  .data
			usr_hip_tl_cfg_func_o               => usr_hip_tl_cfg_func_o,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              --     usr_config_tl.tl_cfg_func
			usr_hip_tl_cfg_add_o                => usr_hip_tl_cfg_add_o,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               --                  .tl_cfg_add
			usr_hip_tl_cfg_ctl_o                => usr_hip_tl_cfg_ctl_o,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               --                  .tl_cfg_ctl
			p0_pld_warm_rst_rdy_i               => p0_pld_warm_rst_rdy_i,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              --            p0_pld.pld_warm_rst_rdy
			p0_pld_link_req_rst_o               => p0_pld_link_req_rst_o,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              --                  .link_req_rst_n
			...
			usr_hip_reconfig_rst_n_i            => '0',                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                --       (terminated)
			usr_hip_reconfig_clk_i              => '0',                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                --       (terminated)
