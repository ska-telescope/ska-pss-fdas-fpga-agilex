	PCIE_HIP_FDAS u0 (
		...
		.intel_pcie_ptile_mcdma_0_usr_msix_valid          (_connected_to_intel_pcie_ptile_mcdma_0_usr_msix_valid_),          //   input,    width = 1,   intel_pcie_ptile_mcdma_0_usr_msix.valid
		.intel_pcie_ptile_mcdma_0_usr_msix_ready          (_connected_to_intel_pcie_ptile_mcdma_0_usr_msix_ready_),          //  output,    width = 1,                                    .ready
		.intel_pcie_ptile_mcdma_0_usr_msix_data           (_connected_to_intel_pcie_ptile_mcdma_0_usr_msix_data_),           //   input,   width = 16,                                    .data
		.intel_pcie_ptile_mcdma_0_p0_pld_pld_warm_rst_rdy (_connected_to_intel_pcie_ptile_mcdma_0_p0_pld_pld_warm_rst_rdy_), //   input,    width = 1,     intel_pcie_ptile_mcdma_0_p0_pld.pld_warm_rst_rdy
		.intel_pcie_ptile_mcdma_0_p0_pld_link_req_rst_n   (_connected_to_intel_pcie_ptile_mcdma_0_p0_pld_link_req_rst_n_),   //  output,    width = 1,                                    .link_req_rst_n
