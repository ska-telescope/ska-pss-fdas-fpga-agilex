// PCIE_HIP_FDAS_altera_mm_interconnect_1920_u7axxza.v
...
`timescale 1 ps / 1 ps
module PCIE_HIP_FDAS_altera_mm_interconnect_1920_u7axxza (
		input  wire [63:0]  intel_pcie_ptile_mcdma_0_d2hdm_master_address,                                      //                                        intel_pcie_ptile_mcdma_0_d2hdm_master.address
		output wire         intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest,                                  //                                                                             .waitrequest
		input  wire [3:0]   intel_pcie_ptile_mcdma_0_d2hdm_master_burstcount,                                   //                                                                             .burstcount
		input  wire [63:0]  intel_pcie_ptile_mcdma_0_d2hdm_master_byteenable,                                   //                                                                             .byteenable
		input  wire         intel_pcie_ptile_mcdma_0_d2hdm_master_read,                                         //                                                                             .read
		output wire [511:0] intel_pcie_ptile_mcdma_0_d2hdm_master_readdata,                                     //                                                                             .readdata
		output wire         intel_pcie_ptile_mcdma_0_d2hdm_master_readdatavalid,                                //                                                                             .readdatavalid
		output wire [1:0]   intel_pcie_ptile_mcdma_0_d2hdm_master_response,                                     //                                                                             .response
		...
		input  wire         intel_pcie_ptile_mcdma_0_d2hdm_master_translator_reset_reset_bridge_in_reset_reset, // intel_pcie_ptile_mcdma_0_d2hdm_master_translator_reset_reset_bridge_in_reset.reset
	...
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_valid;                                     // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:cp_valid -> router:sink_valid
	wire  [691:0] intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_data;                                      // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:cp_data -> router:sink_data
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_ready;                                     // router:sink_ready -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:cp_ready
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_startofpacket;                             // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_endofpacket;                               // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          router_src_valid;                                                                         // router:src_valid -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_sink_valid
	wire  [691:0] router_src_data;                                                                          // router:src_data -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                         // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [3:0] router_src_channel;                                                                       // router:src_channel -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                                                 // router:src_startofpacket -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                                                   // router:src_endofpacket -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_sink_endofpacket
	wire  [691:0] intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_data;                               // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_src_ready
	wire    [3:0] intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_channel;                            // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_startofpacket;                      // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_endofpacket;                        // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                                                        // rsp_mux:src_valid -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_sink_valid
	wire  [691:0] rsp_mux_src_data;                                                                         // rsp_mux:src_data -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                        // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [3:0] rsp_mux_src_channel;                                                                      // rsp_mux:src_channel -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_sink_channel
	wire          rsp_mux_src_startofpacket;                                                                // rsp_mux:src_startofpacket -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                  // rsp_mux:src_endofpacket -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_sink_endofpacket
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_valid;                              // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_src_valid -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:rp_valid
	wire  [691:0] intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_data;                               // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_src_data -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:rp_data
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_ready;                              // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:rp_ready -> intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_src_ready
	wire    [3:0] intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_channel;                            // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_src_channel -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:rp_channel
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_startofpacket;                      // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_src_startofpacket -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:rp_startofpacket
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_endofpacket;                        // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:rsp_src_endofpacket -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:rp_endofpacket
	...
	wire  [511:0] intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_readdata;          // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_readdata -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_readdata
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_waitrequest;       // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_waitrequest -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_waitrequest
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_debugaccess;       // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_debugaccess -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_debugaccess
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_read;              // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_read -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_read
	wire   [63:0] intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_address;           // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_address -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_address
	wire   [63:0] intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_byteenable;        // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_byteenable -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_byteenable
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_readdatavalid;     // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_readdatavalid -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_readdatavalid
	wire    [1:0] intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_response;          // intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_response -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_response
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_lock;              // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_lock -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_lock
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_write;             // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_write -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_write
	wire  [511:0] intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_writedata;         // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_writedata -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_writedata
	wire    [9:0] intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_burstcount;        // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:m0_burstcount -> intel_pcie_ptile_mcdma_0_d2hdm_master_agent:av_burstcount
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_waitrequest;   // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_waitrequest -> intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_waitrequest
	wire  [511:0] intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_readdata;      // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_readdata -> intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_readdata
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_debugaccess;   // intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_debugaccess -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_debugaccess
	wire   [63:0] intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_address;       // intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_address -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_address
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_read;          // intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_read -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_read
	wire   [63:0] intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_byteenable;    // intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_byteenable -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_byteenable
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_readdatavalid; // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_readdatavalid -> intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_readdatavalid
	wire    [1:0] intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_response;      // intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_response -> intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_response
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_lock;          // intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_lock -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_lock
	wire          intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_write;         // intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_write -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_write
	wire  [511:0] intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_writedata;     // intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_writedata -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_writedata
	wire    [9:0] intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_burstcount;    // intel_pcie_ptile_mcdma_0_d2hdm_master_translator:uav_burstcount -> intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter:s0_burstcount
	wire    [3:0] intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_valid_data;                             // intel_pcie_ptile_mcdma_0_d2hdm_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	) intel_pcie_ptile_mcdma_0_d2hdm_master_translator (
		.clk                    (intel_pcie_ptile_mcdma_0_app_clk_clk),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  //   input,    width = 1,                       clk.clk
		.reset                  (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_reset_reset_bridge_in_reset_reset),                                                                                                                                                                                                                                                                                                                                                                                                                                                    //   input,    width = 1,                     reset.reset
		.uav_address            (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_address),                                                                                                                                                                                                                                                                                                                                                                                                                                                    //  output,   width = 64, avalon_universal_master_0.address
		.uav_burstcount         (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_burstcount),                                                                                                                                                                                                                                                                                                                                                                                                                                                 //  output,   width = 10,                          .burstcount
		.uav_read               (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_read),                                                                                                                                                                                                                                                                                                                                                                                                                                                       //  output,    width = 1,                          .read
		.uav_write              (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_write),                                                                                                                                                                                                                                                                                                                                                                                                                                                      //  output,    width = 1,                          .write
		.uav_waitrequest        (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_waitrequest),                                                                                                                                                                                                                                                                                                                                                                                                                                                //   input,    width = 1,                          .waitrequest
		.uav_readdatavalid      (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_readdatavalid),                                                                                                                                                                                                                                                                                                                                                                                                                                              //   input,    width = 1,                          .readdatavalid
		.uav_byteenable         (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_byteenable),                                                                                                                                                                                                                                                                                                                                                                                                                                                 //  output,   width = 64,                          .byteenable
		.uav_readdata           (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_readdata),                                                                                                                                                                                                                                                                                                                                                                                                                                                   //   input,  width = 512,                          .readdata
		.uav_writedata          (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_writedata),                                                                                                                                                                                                                                                                                                                                                                                                                                                  //  output,  width = 512,                          .writedata
		.uav_lock               (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_lock),                                                                                                                                                                                                                                                                                                                                                                                                                                                       //  output,    width = 1,                          .lock
		.uav_debugaccess        (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_debugaccess),                                                                                                                                                                                                                                                                                                                                                                                                                                                //  output,    width = 1,                          .debugaccess
		.uav_response           (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_response),                                                                                                                                                                                                                                                                                                                                                                                                                                                   //   input,    width = 2,                          .response
		.av_address             (intel_pcie_ptile_mcdma_0_d2hdm_master_address),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         //   input,   width = 64,      avalon_anti_master_0.address
		.av_waitrequest         (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     //  output,    width = 1,                          .waitrequest
		.av_burstcount          (intel_pcie_ptile_mcdma_0_d2hdm_master_burstcount),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      //   input,    width = 4,                          .burstcount
		.av_byteenable          (intel_pcie_ptile_mcdma_0_d2hdm_master_byteenable),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      //   input,   width = 64,                          .byteenable
		.av_read                (intel_pcie_ptile_mcdma_0_d2hdm_master_read),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            //   input,    width = 1,                          .read
		.av_readdata            (intel_pcie_ptile_mcdma_0_d2hdm_master_readdata),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        //  output,  width = 512,                          .readdata
		.av_readdatavalid       (intel_pcie_ptile_mcdma_0_d2hdm_master_readdatavalid),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   //  output,    width = 1,                          .readdatavalid
		.av_response            (intel_pcie_ptile_mcdma_0_d2hdm_master_response),                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        //  output,    width = 2,                          .response
	...
	PCIE_HIP_FDAS_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.WUNIQUE_VALUE             (0),
		.SYNC_RESET                (1)
	) intel_pcie_ptile_mcdma_0_d2hdm_master_agent (
		.clk                   (intel_pcie_ptile_mcdma_0_app_clk_clk),                                                 //   input,    width = 1,       clk.clk
		.reset                 (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.av_address            (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_address),       //   input,   width = 64,        av.address
		.av_write              (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_write),         //   input,    width = 1,          .write
		.av_read               (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_read),          //   input,    width = 1,          .read
		.av_writedata          (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_writedata),     //   input,  width = 512,          .writedata
		.av_readdata           (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_readdata),      //  output,  width = 512,          .readdata
		.av_waitrequest        (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_waitrequest),   //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_readdatavalid), //  output,    width = 1,          .readdatavalid
		.av_byteenable         (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_byteenable),    //   input,   width = 64,          .byteenable
		.av_burstcount         (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_burstcount),    //   input,   width = 10,          .burstcount
		.av_debugaccess        (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_debugaccess),   //   input,    width = 1,          .debugaccess
		.av_lock               (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_lock),          //   input,    width = 1,          .lock
		.av_response           (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_response),      //  output,    width = 2,          .response
		.cp_valid              (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_valid),                                 //  output,    width = 1,        cp.valid
		.cp_data               (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_data),                                  //  output,  width = 692,          .data
		.cp_startofpacket      (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_startofpacket),                         //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_endofpacket),                           //  output,    width = 1,          .endofpacket
		.cp_ready              (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_ready),                                 //   input,    width = 1,          .ready
		.rp_valid              (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_valid),                          //   input,    width = 1,        rp.valid
		.rp_data               (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_data),                           //   input,  width = 692,          .data
		.rp_channel            (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_channel),                        //   input,    width = 4,          .channel
		.rp_startofpacket      (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_startofpacket),                  //   input,    width = 1,          .startofpacket
		.rp_endofpacket        (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_endofpacket),                    //   input,    width = 1,          .endofpacket
		.rp_ready              (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_ready),                          //  output,    width = 1,          .ready
		.av_writeresponsevalid ()                                                                                      // (terminated),                         
	);
	...
	PCIE_HIP_FDAS_altera_merlin_router_1921_p6xnp3a router (
		.sink_ready         (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_ready),                               //  output,    width = 1,      sink.ready
		.sink_valid         (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_valid),                               //   input,    width = 1,          .valid
		.sink_data          (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_data),                                //   input,  width = 692,          .data
		.sink_startofpacket (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_startofpacket),                       //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (intel_pcie_ptile_mcdma_0_d2hdm_master_agent_cp_endofpacket),                         //   input,    width = 1,          .endofpacket
		.clk                (intel_pcie_ptile_mcdma_0_app_clk_clk),                                               //   input,    width = 1,       clk.clk
		.reset              (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	PCIE_HIP_FDAS_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.REORDER                   (0)
	) intel_pcie_ptile_mcdma_0_d2hdm_master_limiter (
		.clk                    (intel_pcie_ptile_mcdma_0_app_clk_clk),                                               //   input,    width = 1,       clk.clk
		.reset                  (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.cmd_src_ready          (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_ready),                        //   input,    width = 1,   cmd_src.ready
		.cmd_src_data           (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_data),                         //  output,  width = 692,          .data
		.cmd_src_channel        (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_channel),                      //  output,    width = 4,          .channel
		.cmd_src_startofpacket  (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_startofpacket),                //  output,    width = 1,          .startofpacket
		.cmd_src_endofpacket    (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_endofpacket),                  //  output,    width = 1,          .endofpacket
		...
		.rsp_src_ready          (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_ready),                        //   input,    width = 1,   rsp_src.ready
		.rsp_src_valid          (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_valid),                        //  output,    width = 1,          .valid
		.rsp_src_data           (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_data),                         //  output,  width = 692,          .data
		.rsp_src_channel        (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_channel),                      //  output,    width = 4,          .channel
		.rsp_src_startofpacket  (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_startofpacket),                //  output,    width = 1,          .startofpacket
		.rsp_src_endofpacket    (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_rsp_src_endofpacket),                  //  output,    width = 1,          .endofpacket
		.cmd_src_valid          (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_valid_data)                        //  output,    width = 4, cmd_valid.data
	);

	PCIE_HIP_FDAS_altera_merlin_demultiplexer_1921_maph7pi cmd_demux (
		.clk                (intel_pcie_ptile_mcdma_0_app_clk_clk),                                               //   input,    width = 1,        clk.clk
		.reset              (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		.sink_ready         (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_ready),                        //  output,    width = 1,       sink.ready
		.sink_channel       (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_channel),                      //   input,    width = 4,           .channel
		.sink_data          (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_data),                         //   input,  width = 692,           .data
		.sink_startofpacket (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_startofpacket),                //   input,    width = 1,           .startofpacket
		.sink_endofpacket   (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_src_endofpacket),                  //   input,    width = 1,           .endofpacket
		.sink_valid         (intel_pcie_ptile_mcdma_0_d2hdm_master_limiter_cmd_valid_data),                       //   input,    width = 4, sink_valid.data
	...
	altera_merlin_waitrequest_adapter #(
		...
		.SYNC_RESET               (1)
	) intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter (
		.clk                   (intel_pcie_ptile_mcdma_0_app_clk_clk),                                                     //   input,    width = 1,   clk.clk
		.reset                 (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, reset.reset
		.m0_write              (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_write),             //  output,    width = 1,    m0.write
		.m0_read               (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_read),              //  output,    width = 1,      .read
		.m0_address            (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_address),           //  output,   width = 64,      .address
		.m0_burstcount         (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_burstcount),        //  output,   width = 10,      .burstcount
		.m0_byteenable         (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_byteenable),        //  output,   width = 64,      .byteenable
		.m0_writedata          (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_writedata),         //  output,  width = 512,      .writedata
		.m0_lock               (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_lock),              //  output,    width = 1,      .lock
		.m0_debugaccess        (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_debugaccess),       //  output,    width = 1,      .debugaccess
		.m0_readdata           (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_readdata),          //   input,  width = 512,      .readdata
		.m0_readdatavalid      (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_readdatavalid),     //   input,    width = 1,      .readdatavalid
		.m0_waitrequest        (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_waitrequest),       //   input,    width = 1,      .waitrequest
		.m0_response           (intel_pcie_ptile_mcdma_0_d2hdm_master_waitrequest_allowance_adapter_m0_response),          //   input,    width = 2,      .response
		.s0_write              (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_write),         //   input,    width = 1,    s0.write
		.s0_read               (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_read),          //   input,    width = 1,      .read
		.s0_address            (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_address),       //   input,   width = 64,      .address
		.s0_burstcount         (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_burstcount),    //   input,   width = 10,      .burstcount
		.s0_writedata          (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_writedata),     //   input,  width = 512,      .writedata
		.s0_lock               (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_lock),          //   input,    width = 1,      .lock
		.s0_debugaccess        (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_debugaccess),   //   input,    width = 1,      .debugaccess
		.s0_byteenable         (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_byteenable),    //   input,   width = 64,      .byteenable
		.s0_readdata           (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_readdata),      //  output,  width = 512,      .readdata
		.s0_readdatavalid      (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_readdatavalid), //  output,    width = 1,      .readdatavalid
		.s0_waitrequest        (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_waitrequest),   //  output,    width = 1,      .waitrequest
		.s0_response           (intel_pcie_ptile_mcdma_0_d2hdm_master_translator_avalon_universal_master_0_response),      //  output,    width = 2,      .response
