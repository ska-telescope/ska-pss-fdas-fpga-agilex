// PCIE_HIP_FDAS_altera_mm_interconnect_1920_j5ntm2y.v
...
`timescale 1 ps / 1 ps
module PCIE_HIP_FDAS_altera_mm_interconnect_1920_j5ntm2y (
		input  wire [27:0] intel_pcie_ptile_mcdma_0_rx_pio_master_address,                                      //                                        intel_pcie_ptile_mcdma_0_rx_pio_master.address
		output wire        intel_pcie_ptile_mcdma_0_rx_pio_master_waitrequest,                                  //                                                                              .waitrequest
		input  wire [3:0]  intel_pcie_ptile_mcdma_0_rx_pio_master_burstcount,                                   //                                                                              .burstcount
		input  wire [7:0]  intel_pcie_ptile_mcdma_0_rx_pio_master_byteenable,                                   //                                                                              .byteenable
		input  wire        intel_pcie_ptile_mcdma_0_rx_pio_master_read,                                         //                                                                              .read
		output wire [63:0] intel_pcie_ptile_mcdma_0_rx_pio_master_readdata,                                     //                                                                              .readdata
		output wire        intel_pcie_ptile_mcdma_0_rx_pio_master_readdatavalid,                                //                                                                              .readdatavalid
		input  wire        intel_pcie_ptile_mcdma_0_rx_pio_master_write,                                        //                                                                              .write
		input  wire [63:0] intel_pcie_ptile_mcdma_0_rx_pio_master_writedata,                                    //                                                                              .writedata
		output wire [1:0]  intel_pcie_ptile_mcdma_0_rx_pio_master_response,                                     //                                                                              .response
		output wire        intel_pcie_ptile_mcdma_0_rx_pio_master_writeresponsevalid,                           //                                                                              .writeresponsevalid
		...
		input  wire        intel_pcie_ptile_mcdma_0_rx_pio_master_translator_reset_reset_bridge_in_reset_reset, // intel_pcie_ptile_mcdma_0_rx_pio_master_translator_reset_reset_bridge_in_reset.reset
		input  wire        intel_pcie_ptile_mcdma_0_app_clk_clk                                                 //                                              intel_pcie_ptile_mcdma_0_app_clk.clk
	);

	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_debugaccess;        // intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_debugaccess -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_debugaccess
	wire   [27:0] intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_address;            // intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_address -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_address
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_read;               // intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_read -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_read
	wire    [7:0] intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_byteenable;         // intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_byteenable -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_byteenable
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_readdatavalid;      // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_readdatavalid -> intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_readdatavalid
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_waitrequest;        // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_waitrequest -> intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_waitrequest
	wire   [63:0] intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_readdata;           // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_readdata -> intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_readdata
	wire    [1:0] intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_response;           // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_response -> intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_response
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_lock;               // intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_lock -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_lock
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_write;              // intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_write -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_write
	wire   [63:0] intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_writedata;          // intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_writedata -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_writedata
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_writeresponsevalid; // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_writeresponsevalid -> intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_writeresponsevalid
	wire    [6:0] intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_burstcount;         // intel_pcie_ptile_mcdma_0_rx_pio_master_translator:uav_burstcount -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                              // rsp_mux:src_valid -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:rp_valid
	wire  [146:0] rsp_mux_src_data;                                                                               // rsp_mux:src_data -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                              // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                                            // rsp_mux:src_channel -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                                      // rsp_mux:src_startofpacket -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                        // rsp_mux:src_endofpacket -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:rp_endofpacket
	...
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_valid;                                          // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:cp_valid -> router:sink_valid
	wire  [146:0] intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_data;                                           // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:cp_data -> router:sink_data
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_ready;                                          // router:sink_ready -> intel_pcie_ptile_mcdma_0_rx_pio_master_agent:cp_ready
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_startofpacket;                                  // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_endofpacket;                                    // intel_pcie_ptile_mcdma_0_rx_pio_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	) intel_pcie_ptile_mcdma_0_rx_pio_master_translator (
		.clk                    (intel_pcie_ptile_mcdma_0_app_clk_clk),                                                           //   input,   width = 1,                       clk.clk
		.reset                  (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_reset_reset_bridge_in_reset_reset),            //   input,   width = 1,                     reset.reset
		.uav_address            (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_address),            //  output,  width = 28, avalon_universal_master_0.address
		.uav_burstcount         (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_burstcount),         //  output,   width = 7,                          .burstcount
		.uav_read               (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_read),               //  output,   width = 1,                          .read
		.uav_write              (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_write),              //  output,   width = 1,                          .write
		.uav_waitrequest        (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_waitrequest),        //   input,   width = 1,                          .waitrequest
		.uav_readdatavalid      (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_readdatavalid),      //   input,   width = 1,                          .readdatavalid
		.uav_byteenable         (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_byteenable),         //  output,   width = 8,                          .byteenable
		.uav_readdata           (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_readdata),           //   input,  width = 64,                          .readdata
		.uav_writedata          (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_writedata),          //  output,  width = 64,                          .writedata
		.uav_lock               (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_lock),               //  output,   width = 1,                          .lock
		.uav_debugaccess        (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_debugaccess),        //  output,   width = 1,                          .debugaccess
		.uav_response           (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_response),           //   input,   width = 2,                          .response
		.uav_writeresponsevalid (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_writeresponsevalid), //   input,   width = 1,                          .writeresponsevalid
		.av_address             (intel_pcie_ptile_mcdma_0_rx_pio_master_address),                                                 //   input,  width = 28,      avalon_anti_master_0.address
		.av_waitrequest         (intel_pcie_ptile_mcdma_0_rx_pio_master_waitrequest),                                             //  output,   width = 1,                          .waitrequest
		.av_burstcount          (intel_pcie_ptile_mcdma_0_rx_pio_master_burstcount),                                              //   input,   width = 4,                          .burstcount
		.av_byteenable          (intel_pcie_ptile_mcdma_0_rx_pio_master_byteenable),                                              //   input,   width = 8,                          .byteenable
		.av_read                (intel_pcie_ptile_mcdma_0_rx_pio_master_read),                                                    //   input,   width = 1,                          .read
		.av_readdata            (intel_pcie_ptile_mcdma_0_rx_pio_master_readdata),                                                //  output,  width = 64,                          .readdata
		.av_readdatavalid       (intel_pcie_ptile_mcdma_0_rx_pio_master_readdatavalid),                                           //  output,   width = 1,                          .readdatavalid
		.av_write               (intel_pcie_ptile_mcdma_0_rx_pio_master_write),                                                   //   input,   width = 1,                          .write
		.av_writedata           (intel_pcie_ptile_mcdma_0_rx_pio_master_writedata),                                               //   input,  width = 64,                          .writedata
		.av_response            (intel_pcie_ptile_mcdma_0_rx_pio_master_response),                                                //  output,   width = 2,                          .response
		.av_writeresponsevalid  (intel_pcie_ptile_mcdma_0_rx_pio_master_writeresponsevalid),                                      //  output,   width = 1,                          .writeresponsevalid
	...
	PCIE_HIP_FDAS_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.WUNIQUE_VALUE             (0),
		.SYNC_RESET                (1)
	) intel_pcie_ptile_mcdma_0_rx_pio_master_agent (
		.clk                   (intel_pcie_ptile_mcdma_0_app_clk_clk),                                                           //   input,    width = 1,       clk.clk
		.reset                 (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_reset_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		.av_address            (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_address),            //   input,   width = 28,        av.address
		.av_write              (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_write),              //   input,    width = 1,          .write
		.av_read               (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_read),               //   input,    width = 1,          .read
		.av_writedata          (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_writedata),          //   input,   width = 64,          .writedata
		.av_readdata           (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_readdata),           //  output,   width = 64,          .readdata
		.av_waitrequest        (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_waitrequest),        //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_readdatavalid),      //  output,    width = 1,          .readdatavalid
		.av_byteenable         (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_byteenable),         //   input,    width = 8,          .byteenable
		.av_burstcount         (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_burstcount),         //   input,    width = 7,          .burstcount
		.av_debugaccess        (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_debugaccess),        //   input,    width = 1,          .debugaccess
		.av_lock               (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_lock),               //   input,    width = 1,          .lock
		.av_response           (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_response),           //  output,    width = 2,          .response
		.av_writeresponsevalid (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_avalon_universal_master_0_writeresponsevalid), //  output,    width = 1,          .writeresponsevalid
		.cp_valid              (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_valid),                                          //  output,    width = 1,        cp.valid
		.cp_data               (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_data),                                           //  output,  width = 147,          .data
		.cp_startofpacket      (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_startofpacket),                                  //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_endofpacket),                                    //  output,    width = 1,          .endofpacket
		.cp_ready              (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_ready),                                          //   input,    width = 1,          .ready
	...
	PCIE_HIP_FDAS_altera_merlin_router_1921_p3tohby router (
		.sink_ready         (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_ready),                               //  output,    width = 1,      sink.ready
		.sink_valid         (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_valid),                               //   input,    width = 1,          .valid
		.sink_data          (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_data),                                //   input,  width = 147,          .data
		.sink_startofpacket (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_startofpacket),                       //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (intel_pcie_ptile_mcdma_0_rx_pio_master_agent_cp_endofpacket),                         //   input,    width = 1,          .endofpacket
		.clk                (intel_pcie_ptile_mcdma_0_app_clk_clk),                                                //   input,    width = 1,       clk.clk
		.reset              (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	PCIE_HIP_FDAS_altera_merlin_burst_adapter_1922_yda6ubq #(
		.PKT_ADDR_H                (99),
		.PKT_ADDR_L                (72),
		.PKT_BEGIN_BURST           (121),
		.PKT_BYTE_CNT_H            (112),
		...
		.reset                 (intel_pcie_ptile_mcdma_0_rx_pio_master_translator_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
