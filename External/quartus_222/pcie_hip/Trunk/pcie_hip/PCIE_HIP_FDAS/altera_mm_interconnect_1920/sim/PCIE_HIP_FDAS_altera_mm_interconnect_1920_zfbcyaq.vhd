-- PCIE_HIP_FDAS_altera_mm_interconnect_1920_zfbcyaq.vhd
...
entity PCIE_HIP_FDAS_altera_mm_interconnect_1920_zfbcyaq is
	port (
		intel_pcie_ptile_mcdma_0_h2ddm_master_address                                      : in  std_logic_vector(63 downto 0)  := (others => '0'); --                                        intel_pcie_ptile_mcdma_0_h2ddm_master.address
		intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest                                  : out std_logic;                                         --                                                                             .waitrequest
		intel_pcie_ptile_mcdma_0_h2ddm_master_burstcount                                   : in  std_logic_vector(3 downto 0)   := (others => '0'); --                                                                             .burstcount
		intel_pcie_ptile_mcdma_0_h2ddm_master_byteenable                                   : in  std_logic_vector(63 downto 0)  := (others => '0'); --                                                                             .byteenable
		intel_pcie_ptile_mcdma_0_h2ddm_master_write                                        : in  std_logic                      := '0';             --                                                                             .write
		intel_pcie_ptile_mcdma_0_h2ddm_master_writedata                                    : in  std_logic_vector(511 downto 0) := (others => '0'); --                                                                             .writedata
		...
		intel_pcie_ptile_mcdma_0_h2ddm_master_translator_reset_reset_bridge_in_reset_reset : in  std_logic                      := '0';             -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator_reset_reset_bridge_in_reset.reset
		intel_pcie_ptile_mcdma_0_app_clk_clk                                               : in  std_logic                      := '0'              --                                             intel_pcie_ptile_mcdma_0_app_clk.clk
	);
end entity PCIE_HIP_FDAS_altera_mm_interconnect_1920_zfbcyaq;

architecture rtl of PCIE_HIP_FDAS_altera_mm_interconnect_1920_zfbcyaq is
	...
	signal rsp_mux_src_valid                                                                        : std_logic;                      -- rsp_mux:src_valid -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:rp_valid
	signal rsp_mux_src_data                                                                         : std_logic_vector(691 downto 0); -- rsp_mux:src_data -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:rp_data
	signal rsp_mux_src_ready                                                                        : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_agent:rp_ready -> rsp_mux:src_ready
	signal rsp_mux_src_channel                                                                      : std_logic_vector(3 downto 0);   -- rsp_mux:src_channel -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:rp_channel
	signal rsp_mux_src_startofpacket                                                                : std_logic;                      -- rsp_mux:src_startofpacket -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:rp_startofpacket
	signal rsp_mux_src_endofpacket                                                                  : std_logic;                      -- rsp_mux:src_endofpacket -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:rp_endofpacket
	...
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_valid                                     : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_agent:cp_valid -> router:sink_valid
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_data                                      : std_logic_vector(691 downto 0); -- intel_pcie_ptile_mcdma_0_h2ddm_master_agent:cp_data -> router:sink_data
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_ready                                     : std_logic;                      -- router:sink_ready -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:cp_ready
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_startofpacket                             : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_agent:cp_startofpacket -> router:sink_startofpacket
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_endofpacket                               : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_readdata          : std_logic_vector(511 downto 0); -- intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_readdata -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_readdata
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_waitrequest       : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_waitrequest -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_waitrequest
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_debugaccess       : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_debugaccess -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_debugaccess
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_read              : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_read -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_read
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_address           : std_logic_vector(63 downto 0);  -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_address -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_address
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_byteenable        : std_logic_vector(63 downto 0);  -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_byteenable -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_byteenable
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_readdatavalid     : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_readdatavalid -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_readdatavalid
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_lock              : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_lock -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_lock
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_write             : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_write -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_write
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_writedata         : std_logic_vector(511 downto 0); -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_writedata -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_writedata
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_burstcount        : std_logic_vector(9 downto 0);   -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:m0_burstcount -> intel_pcie_ptile_mcdma_0_h2ddm_master_agent:av_burstcount
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_waitrequest   : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_waitrequest -> intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_waitrequest
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_readdata      : std_logic_vector(511 downto 0); -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_readdata -> intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_readdata
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_debugaccess   : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_debugaccess -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_debugaccess
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_address       : std_logic_vector(63 downto 0);  -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_address -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_address
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_read          : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_read -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_read
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_byteenable    : std_logic_vector(63 downto 0);  -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_byteenable -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_byteenable
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_readdatavalid : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_readdatavalid -> intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_readdatavalid
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_lock          : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_lock -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_lock
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_write         : std_logic;                      -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_write -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_write
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_writedata     : std_logic_vector(511 downto 0); -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_writedata -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_writedata
	signal intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_burstcount    : std_logic_vector(9 downto 0);   -- intel_pcie_ptile_mcdma_0_h2ddm_master_translator:uav_burstcount -> intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter:s0_burstcount
	...
	for intel_pcie_ptile_mcdma_0_h2ddm_master_translator : PCIE_HIP_FDAS_altera_merlin_master_translator_191_q6cbhvi_cmp
	...
	for dma_rd_3_s0_translator : PCIE_HIP_FDAS_altera_merlin_slave_translator_191_x56fcki_cmp
		use entity altera_merlin_slave_translator_191.PCIE_HIP_FDAS_altera_merlin_slave_translator_191_x56fcki;
	for intel_pcie_ptile_mcdma_0_h2ddm_master_agent : PCIE_HIP_FDAS_altera_merlin_master_agent_191_mpbm6tq_cmp
	...
	for intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter : altera_merlin_waitrequest_adapter_cmp
...
begin
	...
	intel_pcie_ptile_mcdma_0_h2ddm_master_translator : component PCIE_HIP_FDAS_altera_merlin_master_translator_191_q6cbhvi_cmp
		generic map (
			AV_ADDRESS_W                => 64,
			AV_DATA_W                   => 512,
			AV_BURSTCOUNT_W             => 4,
		...
		port map (
			...
			reset                  => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_reset_reset_bridge_in_reset_reset,       --                     reset.reset
			uav_address            => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_address,       -- avalon_universal_master_0.address
			uav_burstcount         => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_burstcount,    --                          .burstcount
			uav_read               => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_read,          --                          .read
			uav_write              => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_write,         --                          .write
			uav_waitrequest        => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_waitrequest,   --                          .waitrequest
			uav_readdatavalid      => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_readdatavalid, --                          .readdatavalid
			uav_byteenable         => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_byteenable,    --                          .byteenable
			uav_readdata           => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_readdata,      --                          .readdata
			uav_writedata          => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_writedata,     --                          .writedata
			uav_lock               => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_lock,          --                          .lock
			uav_debugaccess        => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_debugaccess,   --                          .debugaccess
			av_address             => intel_pcie_ptile_mcdma_0_h2ddm_master_address,                                            --      avalon_anti_master_0.address
			av_waitrequest         => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest,                                        --                          .waitrequest
			av_burstcount          => intel_pcie_ptile_mcdma_0_h2ddm_master_burstcount,                                         --                          .burstcount
			av_byteenable          => intel_pcie_ptile_mcdma_0_h2ddm_master_byteenable,                                         --                          .byteenable
			av_write               => intel_pcie_ptile_mcdma_0_h2ddm_master_write,                                              --                          .write
			av_writedata           => intel_pcie_ptile_mcdma_0_h2ddm_master_writedata,                                          --                          .writedata
	...
	intel_pcie_ptile_mcdma_0_h2ddm_master_agent : component PCIE_HIP_FDAS_altera_merlin_master_agent_191_mpbm6tq_cmp
		generic map (
			PKT_WUNIQUE               => 691,
			PKT_DOMAIN_H              => 690,
			PKT_DOMAIN_L              => 689,
		...
		port map (
			clk                   => intel_pcie_ptile_mcdma_0_app_clk_clk,                                                 --       clk.clk
			reset                 => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_reset_reset_bridge_in_reset_reset,   -- clk_reset.reset
			av_address            => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_address,       --        av.address
			av_write              => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_write,         --          .write
			av_read               => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_read,          --          .read
			av_writedata          => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_writedata,     --          .writedata
			av_readdata           => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_readdata,      --          .readdata
			av_waitrequest        => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_waitrequest,   --          .waitrequest
			av_readdatavalid      => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_readdatavalid, --          .readdatavalid
			av_byteenable         => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_byteenable,    --          .byteenable
			av_burstcount         => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_burstcount,    --          .burstcount
			av_debugaccess        => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_debugaccess,   --          .debugaccess
			av_lock               => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_lock,          --          .lock
			cp_valid              => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_valid,                                 --        cp.valid
			cp_data               => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_data,                                  --          .data
			cp_startofpacket      => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_startofpacket,                         --          .startofpacket
			cp_endofpacket        => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_endofpacket,                           --          .endofpacket
			cp_ready              => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_ready,                                 --          .ready
	...
	router : component PCIE_HIP_FDAS_altera_merlin_router_1921_22ekohy_cmp
		port map (
			sink_ready         => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_ready,                               --      sink.ready
			sink_valid         => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_valid,                               --          .valid
			sink_data          => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_data,                                --          .data
			sink_startofpacket => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_startofpacket,                       --          .startofpacket
			sink_endofpacket   => intel_pcie_ptile_mcdma_0_h2ddm_master_agent_cp_endofpacket,                         --          .endofpacket
			clk                => intel_pcie_ptile_mcdma_0_app_clk_clk,                                               --       clk.clk
			reset              => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_reset_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter : component altera_merlin_waitrequest_adapter_cmp
		generic map (
			UAV_ADDRESS_W            => 64,
			UAV_BYTEENABLE_W         => 64,
			UAV_BURSTCOUNT_W         => 10,
		...
		port map (
			clk                   => intel_pcie_ptile_mcdma_0_app_clk_clk,                                                     --   clk.clk
			reset                 => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_reset_reset_bridge_in_reset_reset,       -- reset.reset
			m0_write              => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_write,             --    m0.write
			m0_read               => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_read,              --      .read
			m0_address            => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_address,           --      .address
			m0_burstcount         => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_burstcount,        --      .burstcount
			m0_byteenable         => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_byteenable,        --      .byteenable
			m0_writedata          => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_writedata,         --      .writedata
			m0_lock               => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_lock,              --      .lock
			m0_debugaccess        => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_debugaccess,       --      .debugaccess
			m0_readdata           => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_readdata,          --      .readdata
			m0_readdatavalid      => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_readdatavalid,     --      .readdatavalid
			m0_waitrequest        => intel_pcie_ptile_mcdma_0_h2ddm_master_waitrequest_allowance_adapter_m0_waitrequest,       --      .waitrequest
			s0_write              => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_write,         --    s0.write
			s0_read               => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_read,          --      .read
			s0_address            => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_address,       --      .address
			s0_burstcount         => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_burstcount,    --      .burstcount
			s0_writedata          => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_writedata,     --      .writedata
			s0_lock               => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_lock,          --      .lock
			s0_debugaccess        => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_debugaccess,   --      .debugaccess
			s0_byteenable         => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_byteenable,    --      .byteenable
			s0_readdata           => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_readdata,      --      .readdata
			s0_readdatavalid      => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_readdatavalid, --      .readdatavalid
			s0_waitrequest        => intel_pcie_ptile_mcdma_0_h2ddm_master_translator_avalon_universal_master_0_waitrequest,   --      .waitrequest
...
end architecture rtl; -- of PCIE_HIP_FDAS_altera_mm_interconnect_1920_zfbcyaq
