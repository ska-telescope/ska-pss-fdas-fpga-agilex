...
namespace eval FDAS_DDR_CONTROLLER {
  ...
  proc get_memory_files {QSYS_SIMDIR} {
    ...
    lappend memory_files "[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_vkchklq_seq_params_synth.hex"]"
    return $memory_files
  }
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_vkchklq_top.sv"]\"  -work altera_emif_arch_fm_191"
    ...
    lappend design_files "vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/FDAS_DDR_CONTROLLER_altera_emif_arch_fm_191_vkchklq.vhd"]\"  -work altera_emif_arch_fm_191"          
    lappend design_files "vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/../altera_emif_fm_261/sim/FDAS_DDR_CONTROLLER_altera_emif_fm_261_6jnm2ai.vhd"]\"  -work altera_emif_fm_261"                         
