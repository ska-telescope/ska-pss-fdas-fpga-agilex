...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_corename}"
   } else {
      set fbasename "${::GLOBAL_ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_corename}_${inst_id}"
   }
   ...
   ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_perform_core_analysis $opcname $inst pins var summary


   set summary [lsort -command ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ ed_synth_emif_fm_0_altera_emif_arch_fm_191_gnkuqey_round_3dp $hold]
      }
