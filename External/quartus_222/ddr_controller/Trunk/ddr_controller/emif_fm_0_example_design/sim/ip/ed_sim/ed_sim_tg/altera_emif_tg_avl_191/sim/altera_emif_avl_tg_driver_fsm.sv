...
module altera_emif_avl_tg_driver_fsm # (
   ...
   // Test stages
   test_stage_t                      stage /* synthesis ignore_power_up */;
   ...
   begin
      case (stage)
         SINGLE_RW:
         begin
            addr_gen_select_int <= single_rw_addr_gen_select;
         ...
         BLOCK_RW:
         begin
            addr_gen_select_int <= block_rw_addr_gen_select;
         ...
         BYTEENABLE_STAGE:
         begin
            addr_gen_select_int <= byteenable_stage_addr_gen_select;
         ...
         TEMPLATE_STAGE:
         begin
            addr_gen_select_int <= template_stage_addr_gen_select;
         ...
         REREAD_STAGE:
         begin
            addr_gen_select_int <= addr_gen_select_t'('b0);  
            do_write            <= 1'b0;
            do_read             <= can_read;
         end
