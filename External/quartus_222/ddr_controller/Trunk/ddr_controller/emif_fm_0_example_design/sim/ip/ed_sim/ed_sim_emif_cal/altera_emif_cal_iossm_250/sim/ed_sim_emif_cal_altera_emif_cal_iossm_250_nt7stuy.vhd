...
entity ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy is
   generic (
...
end entity ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy;

architecture rtl of ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy is
   component ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy_arch is
      generic (
         NUM_CALBUS_USED                                    : integer                                  := 0;
         USE_SYNTH_FOR_SIM                                  : integer                                  := 0;
         USE_SOFT_NIOS                                      : integer                                  := 0;
   ...
   end component ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy_arch;

begin
   arch_inst : component ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy_arch
      generic map (
         ...
         IOSSM_CODE_HEX_FILENAME => "ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy_code.hex",
         IOSSM_SIM_GPT_HEX_FILENAME => "ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy_sim_global_param_tbl.hex",
         IOSSM_SYNTH_GPT_HEX_FILENAME => "ed_sim_emif_cal_altera_emif_cal_iossm_250_nt7stuy_synth_global_param_tbl.hex"
      )
      port map (
