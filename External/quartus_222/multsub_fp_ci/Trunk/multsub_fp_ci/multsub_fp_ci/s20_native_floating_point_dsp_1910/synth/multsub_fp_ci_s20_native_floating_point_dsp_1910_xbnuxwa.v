...
module  multsub_fp_ci_s20_native_floating_point_dsp_1910_xbnuxwa  (
           ...
           fp32_result);
            ...
            input  clr1;
            input [2:0] ena;
            input [31:0] fp32_chainin;
            input [31:0] fp32_mult_a;
            input [31:0] fp32_mult_b;
            ...
            defparam
                    tennm_fp_mac_component.operation_mode = "fp32_mult_add",
                    ...
                    tennm_fp_mac_component.fp32_adder_subtract = "true",
                    ...
                    tennm_fp_mac_component.fp32_adder_a_clken = "no_reg",
                    tennm_fp_mac_component.fp32_adder_b_clken = "no_reg",
                    tennm_fp_mac_component.fp32_mult_a_clken = "0",
                    tennm_fp_mac_component.fp32_mult_b_clken = "0",
