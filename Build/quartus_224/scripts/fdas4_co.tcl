...
# Script to checkout everything to build FDAS (with Quartus 22.4).
...
#exec svn co $repo/Build/quartus_224/fdas_top/Trunk/fdas_top

# Sources will be stored under './Projects/SKA'.
file mkdir $target/altera/quartus/22.4
...
foreach ip $iplist {
  puts "Getting IP $ip ..."
  exec svn co $repo/External/quartus_224/$ip/Trunk/$ip $target/altera/quartus/22.4/$ip
}
...
set revisions [list 2237 2785 2641 2646   2255     2752      2565     3022 2643    2278 2334     2286]
...
#file copy {*}[glob $target/altera/quartus/22.4/fft1024/fft1024/intel_FPGA_unified_fft_101/synth/*.hex] fdas_top
