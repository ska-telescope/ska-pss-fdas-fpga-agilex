...
% Harmonic 1:    20            45 (Filter P[+2])                100.3
...
% Harmonic 8:   163            59 (Filter P[+16])                30.3
...
% DDR SDRAM#2
FOP_DDR_2(1285)  = 100.3 %Harmonic#1,P[+2] 
FOP_DDR_2(2633)  =  90.3 %Harmonic#2,P[+4]
FOP_DDR_2(3917)  =  80.3 %Harmonic#3,P[+6]  
FOP_DDR_2(10453) =  30.3 %Harmonic#8,P[+16] 

% DDR SDRAM#3
FOP_DDR_3(5251)  =  70.3 %Harmonic#4,P[+8]
FOP_DDR_3(6535)  =  60.3 %Harmonic#5,P[+10]
FOP_DDR_3(7883)  =  50.3 %Harmonic#6,P[+12]
FOP_DDR_3(9167)  =  40.3 %Harmonic#7,P[+14]
