...
% Harmonic 1:    20            45 (Filter P[+2])                100.6
% Harmonic 2:    39            47 (Filter P[+4])                90.6
% Harmonic 3:    59            49 (Filter P[+6])                80.6
% Harmonic 4:    78            51 (Filter P[+8])                70.6
% Harmonic 5:    98            53 (Filter P[+10])               60.6
% Harmonic 6:   118            55 (Filter P[+12])               50.6
% Harmonic 7:   138            57 (Filter P[+14])               40.6
% Harmonic 8:   158            59 (Filter P[+16])               30.6
...
% DDR SDRAM#2
FOP_DDR_2(1285)  = 100.6 %Harmonic#1,P[+2] 
FOP_DDR_2(2505)  = 90.6 %Harmonic#2,P[+4]
FOP_DDR_2(3789)  = 80.6 %Harmonic#3,P[+6]  
FOP_DDR_2(10133) = 30.6 %Harmonic#8,P[+16] 

% DDR SDRAM#3
FOP_DDR_3(4995)  = 70.6 %Harmonic#4,P[+8]
FOP_DDR_3(6279)  = 60.6 %Harmonic#5,P[+10]
FOP_DDR_3(7563)  = 50.6 %Harmonic#6,P[+12]
FOP_DDR_3(8847)  = 40.6 %Harmonic#7,P[+14]
