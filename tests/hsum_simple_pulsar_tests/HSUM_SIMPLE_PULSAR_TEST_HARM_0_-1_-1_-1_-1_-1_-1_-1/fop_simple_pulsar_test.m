...
% Harmonic 1:    20            45 (Filter P[+2])                100.5
% Harmonic 2:    39            47 (Filter P[+4])                90.5
% Harmonic 3:    59            49 (Filter P[+6])                80.5
% Harmonic 4:    79            51 (Filter P[+8])                70.5
% Harmonic 5:    99            53 (Filter P[+10])               60.5
% Harmonic 6:   119            55 (Filter P[+12])               50.5
% Harmonic 7:   139            57 (Filter P[+14])               40.5
% Harmonic 8:   159            59 (Filter P[+16])               30.5
...
% DDR SDRAM#2
FOP_DDR_2(1285)  = 100.5 %Harmonic#1,P[+2] 
FOP_DDR_2(2505)  = 90.5 %Harmonic#2,P[+4]
FOP_DDR_2(3789)  = 80.5 %Harmonic#3,P[+6]  
FOP_DDR_2(10197) = 30.5 %Harmonic#8,P[+16] 

% DDR SDRAM#3
FOP_DDR_3(5059)  = 70.5 %Harmonic#4,P[+8]
FOP_DDR_3(6343)  = 60.5 %Harmonic#5,P[+10]
FOP_DDR_3(7627)  = 50.5 %Harmonic#6,P[+12]
FOP_DDR_3(8911)  = 40.5 %Harmonic#7,P[+14]
